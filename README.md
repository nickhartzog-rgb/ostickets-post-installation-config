...
<p>
We're gonna start with some important links. This [Link](http://localhost/osTicket/scp/login.php) will take you to the Admin/Agent login page, where you can log in and close tickets opened by the users. 
</p>
<br />
